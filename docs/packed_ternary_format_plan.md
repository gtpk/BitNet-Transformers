...
### Phase 3: `PackedTernaryLinear` reference runtime PoC
...
format/TC가 고정되고 모델 단위 export가 logit 동일성을 통과했다. 다음은:

1. `PackedTernaryLinear` reference runtime으로 packed 경로 정확성 확정
